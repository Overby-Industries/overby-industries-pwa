  ...
  return (
    <form onSubmit={handleDonate} className="flex flex-col items-center gap-4">
      <div className="flex gap-2 items-center">
        <span className="text-xl text-gray-300 font-medium">$</span>
        <input
          type="number"
          min="1"
          step="0.01"
          ...
          className="px-4 py-2 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:ring-2 focus:ring-cyan-400 outline-none"
        />
      </div>
